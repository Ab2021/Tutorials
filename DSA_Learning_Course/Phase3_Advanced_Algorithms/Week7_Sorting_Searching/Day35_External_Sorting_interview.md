# Day 35: External Sorting - Interview Preparation
...
## Problem 1: Basic External Sorting Application
...
**Question**: Design a system component using External Sorting

**Answer Framework**:
1. **Requirements**: Clarify functional and non-functional requirements
2. **Data Structure Choice**: Why External Sorting is appropriate
...
2. **Q**: When should you use External Sorting?
   **A**: [Explanation]
...
1. Implement External Sorting from scratch with full test coverage
2. Solve 5 LeetCode problems using External Sorting
3. Write a blog post explaining External Sorting to beginners
4. Optimize a real-world codebase using External Sorting
