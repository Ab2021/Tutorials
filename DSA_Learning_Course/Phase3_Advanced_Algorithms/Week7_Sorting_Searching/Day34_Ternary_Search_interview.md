# Day 34: Ternary Search & Exponential Search - Interview Preparation
...
## Problem 1: Basic Ternary Search & Exponential Search Application
...
**Question**: Design a system component using Ternary Search & Exponential Search

**Answer Framework**:
1. **Requirements**: Clarify functional and non-functional requirements
2. **Data Structure Choice**: Why Ternary Search & Exponential Search is appropriate
...
2. **Q**: When should you use Ternary Search & Exponential Search?
   **A**: [Explanation]
...
1. Implement Ternary Search & Exponential Search from scratch with full test coverage
2. Solve 5 LeetCode problems using Ternary Search & Exponential Search
3. Write a blog post explaining Ternary Search & Exponential Search to beginners
4. Optimize a real-world codebase using Ternary Search & Exponential Search
