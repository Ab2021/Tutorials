# Day 63: Design HashMap from Scratch - Deep Dive
...
The mathematical principles underlying Design HashMap from Scratch:
...
**Further Reading**:
- Research papers on Design HashMap from Scratch
