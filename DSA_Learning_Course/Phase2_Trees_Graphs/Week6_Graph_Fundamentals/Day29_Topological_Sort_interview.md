# Day 29: Topological Sort - Interview Preparation
...
## Problem 1: Basic Topological Sort Application
...
**Question**: Design a system component using Topological Sort

**Answer Framework**:
1. **Requirements**: Clarify functional and non-functional requirements
2. **Data Structure Choice**: Why Topological Sort is appropriate
...
2. **Q**: When should you use Topological Sort?
   **A**: [Explanation]
...
1. Implement Topological Sort from scratch with full test coverage
2. Solve 5 LeetCode problems using Topological Sort
3. Write a blog post explaining Topological Sort to beginners
4. Optimize a real-world codebase using Topological Sort

---

**Next**: [Day 30](Day30_*.md)
