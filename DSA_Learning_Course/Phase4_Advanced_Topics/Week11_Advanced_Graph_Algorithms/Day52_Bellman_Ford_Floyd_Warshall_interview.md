# Day 52: Bellman-Ford & Floyd-Warshall - Interview Preparation
...
## Problem 1: Basic Bellman-Ford & Floyd-Warshall Application
...
**Question**: Design a system component using Bellman-Ford & Floyd-Warshall

**Answer Framework**:
1. **Requirements**: Clarify functional and non-functional requirements
2. **Data Structure Choice**: Why Bellman-Ford & Floyd-Warshall is appropriate
...
2. **Q**: When should you use Bellman-Ford & Floyd-Warshall?
   **A**: [Explanation]
...
1. Implement Bellman-Ford & Floyd-Warshall from scratch with full test coverage
2. Solve 5 LeetCode problems using Bellman-Ford & Floyd-Warshall
3. Write a blog post explaining Bellman-Ford & Floyd-Warshall to beginners
4. Optimize a real-world codebase using Bellman-Ford & Floyd-Warshall
