# Day 55: Strongly Connected Components - Interview Preparation
...
## Problem 1: Basic Strongly Connected Components Application
...
**Question**: Design a system component using Strongly Connected Components

**Answer Framework**:
1. **Requirements**: Clarify functional and non-functional requirements
2. **Data Structure Choice**: Why Strongly Connected Components is appropriate
...
2. **Q**: When should you use Strongly Connected Components?
   **A**: [Explanation]
...
1. Implement Strongly Connected Components from scratch with full test coverage
2. Solve 5 LeetCode problems using Strongly Connected Components
3. Write a blog post explaining Strongly Connected Components to beginners
4. Optimize a real-world codebase using Strongly Connected Components
